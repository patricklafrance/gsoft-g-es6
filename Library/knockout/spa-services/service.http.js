...
(function($, utils, mediator, shell) {
    services.http = {
        ...
        get: function(options) {
            gsoft.ensure(options, "options", "HttpService.get").isNotNull();
            gsoft.ensure(options.url, "options.url", "HttpService.get").isNotNullOrEmpty();
        ...
        post: function(options) {
            gsoft.ensure(options, "options", "HttpService.post").isNotNull();
            gsoft.ensure(options.url, "options.url", "HttpService.post").isNotNullOrEmpty();
            gsoft.ensure(options.data, "options.data", "HttpService.post").isNotNull();
        ...
        put: function(options) {
            gsoft.ensure(options, "options", "HttpService.put").isNotNull();
            gsoft.ensure(options.url, "options.url", "HttpService.put").isNotNullOrEmpty();
            gsoft.ensure(options.data, "options.data", "HttpService.put").isNotNull();
        ...
        remove: function(options) {
            gsoft.ensure(options, "options", "HttpService.remove").isNotNull();
            gsoft.ensure(options.url, "options.url", "HttpService.remove").isNotNullOrEmpty();
        ...
        _send: function(request) {
            ...
            request.beforeSend = function(jqxhr, settings) {
                ...
                mediator.publishSilently(spa.Channel.HttpBeforeRequest, request, jqxhr, settings);
            };
            ...
            promise.fail(function(jqxhr, textStatus, errorThrown) {                
                ...
                shell.publishError("http-service", "RequestFailed", {
                    request: request,
                    jqxhr: jqxhr,
            ...
            promise.done(function(data, textStatus, jqxhr) {
                ...
                mediator.publishSilently(spa.Channel.HttpRequestSucceeded, request, result, textStatus, jqxhr);
            });
                            
            promise.always(function(param1, param2, param3) {
                mediator.publishSilently(spa.Channel.HttpRequestCompleted, request, param1, param2, param3);
            });
